      ...
      podcasts: [
        {
          ...
          transcript: "This episode talks about model quality and agent workflows."
        }
      ]
    }
  };
...
test("favorite builders outrank plain keyword matches", () => {
  const result = buildDigestFromFeeds({
    profile,
    ...buildFeeds(),
...
test("empty candidates still produce a stable digest", () => {
  const result = buildDigestFromFeeds({
